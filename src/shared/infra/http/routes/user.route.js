...
const findAllTicketsBoughtByEventIdUseCase = new FindAllTicketsBoughtByEventIdUseCase(ticketRepositoryMYSQL);
...
const buyTicketController = new BuyTicketController(findOneEventByIdUseCase, buyTicketUseCase, findAllTicketsBoughtByEventIdUseCase);
