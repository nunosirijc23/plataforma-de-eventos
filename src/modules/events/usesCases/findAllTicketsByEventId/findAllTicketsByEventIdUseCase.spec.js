...
const FindAllTicketsByEventIdUseCase = require('./findAllTicketsByEventIdUseCase');
...
let findAllTicketsByEventIdUseCase;
...
describe("Buy Ticket Use Case", () => {
    beforeEach(() => {
        ...
        findAllTicketsByEventIdUseCase = new FindAllTicketsByEventIdUseCase(ticketRepositoryInMemory);
    })
    ...
    it("should be able to find all tickets by event id", async () => {
        ...
        const ticketFetched = await findAllTicketsByEventIdUseCase.execute(event.id);
